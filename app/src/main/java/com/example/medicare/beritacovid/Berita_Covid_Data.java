...
public class Berita_Covid_Data {
    ...
    private static String[] cuplikan = {
            ...
            "Dokter hingga kini masih berusaha memahami gambaran lengkap virus covid-19.",
    };
    ...
    public static ArrayList<Berita_Covid> getListData() {
        ...
        for (int position = 0; position < judulBerita.length; position++) {
            ...
            beritacovid.setCuplikan(cuplikan[position]);
            beritacovid.setDescription(description[position]);
