...
public class CreateEvent extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editext_message3 = findViewById(R.id.editext_message3);
    ...
    private void submit() {
        ...
        String text2 = editext_message2.getText().toString().trim();
        String text3 = editext_message3.getText().toString().trim();
        if (text.isEmpty()) {
            ...
            if (btn_time.getText().toString().equals("Select Time") || btn_date.getText().toString().equals("Select date")) {
                ...
                String value2 = (editext_message2.getText().toString().trim());
                String value3 = (editext_message3.getText().toString().trim());
                ...
                entityClass.setJumlahobat(value2);
                entityClass.setKeterangan(value3);
                entityClass.setEventtime(time);
                databaseClass.EventDao().insertAll(entityClass);
                setAlarm(value,value2,value3, date, time);
            }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK && data != null) {
                ...
                editext_message2.setText(text2.get(0));
                ArrayList<String> text3 = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                editext_message3.setText(text3.get(0));
            }
        }

    }

    private void setAlarm(String text,String text2,String text3, String date, String time) {
        AlarmManager am = (AlarmManager) getSystemService(Context.ALARM_SERVICE);

        Intent intent = new Intent(getApplicationContext(), AlarmBroadcast.class);
        intent.putExtra("event", text);
        intent.putExtra("event2", text2);
        intent.putExtra("event3", text3);
